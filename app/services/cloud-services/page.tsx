...
export default function CloudServicesPage() {
  const otherServices = [
    ...
    { name: "Cloud Services", active: true, slug: "cloud-services" },
  ];

  return (
    <main className="bg-[#F4F7FA] min-h-screen font-sans">
      <ServiceHero title="Cloud Services" />
        ...
        <div className="w-[90%] flex flex-col lg:flex-row gap-12">
            ...
            <div className="sticky top-28 space-y-8">
              ...
              <div className="bg-blue-600 rounded-xl p-8 text-white text-center relative overflow-hidden shadow-xl">
                <div className="relative z-10">
                  ...
                  <h4 className="text-2xl font-bold mb-2">Ready to Migrate?</h4>
                  <p className="text-blue-100 text-sm mb-6 font-light">Zero-downtime migration for Nairobi enterprises.</p>
          ...
          <div className="lg:w-2/3 order-1 lg:order-2 space-y-12">
            <div className="bg-white p-10 md:p-16 rounded-2xl border border-slate-100 shadow-sm">
              <h2 className="text-3xl md:text-5xl font-bold text-slate-900 mb-10 tracking-tight">Scale Without Boundaries. <br/> Deploy Anywhere.</h2>
              
              <p className="text-slate-600 text-lg leading-loose mb-12 font-light">
                Leverage the power of AWS, Azure, and Google Cloud with local expertise. FenTech designs high-availability cloud architectures that reduce operational costs, enhance collaboration, and provide the elastic computing power your business needs to stay competitive.
              </p>
             ...
             <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
              <div className="bg-white p-8 rounded-2xl border border-slate-100 shadow-sm">
                ...
                <h3 className="text-xl font-bold text-slate-900 mb-3">Infinite Storage</h3>
                <p className="text-slate-500 text-sm leading-relaxed font-light">
                  Highly secure and redundant data storage solutions that scale 
                  automatically as your business records grow.
                </p>
              </div>
              <div className="bg-white p-8 rounded-2xl border border-slate-100 shadow-sm">
                <RefreshCw className="text-blue-600 mb-4" size={32} />
                <h3 className="text-xl font-bold text-slate-900 mb-3">Seamless Sync</h3>
                <p className="text-slate-500 text-sm leading-relaxed font-light">
                  Maintain business continuity with real-time synchronization between 
                  your on-premise hardware and cloud environments.
                </p>
              </div>
            </div>
          </div>
          ...
          <div className="relative z-10">
            <div className="grid grid-cols-1 lg:grid-cols-12 gap-16">
              <div className="lg:col-span-4 space-y-10">
                <div>
                  <div className="flex items-center gap-3 mb-4">
                    ...
                    <span className="text-blue-500 font-bold uppercase tracking-widest text-xs">Modernize today</span>
                  </div>
                  <h2 className="text-4xl font-bold text-white leading-tight mb-6 tracking-tight">Move Your Business <br /> to the Cloud</h2>
                  <p className="text-slate-400 text-lg font-light leading-relaxed">Let our certified cloud architects map out your journey to a more flexible infrastructure.</p>
                </div>
                <div className="p-8 bg-white/5 border border-white/10 rounded-2xl backdrop-blur-sm shadow-2xl">
                  <p className="text-blue-500 uppercase tracking-widest text-[10px] font-black mb-2">Cloud Strategy Desk:</p>
              ...
              <div className="lg:col-span-3 space-y-8 lg:border-l lg:border-white/10 lg:pl-12">
                <h4 className="text-white font-bold mb-8 uppercase tracking-wider text-xs opacity-70">Migration Steps</h4>
                <div className="space-y-12 relative">
                  <div className="absolute left-[19px] top-2 bottom-2 w-[1px] bg-white/10 -z-0" />
                  {[
                    { step: "1", title: "Readiness", desc: "Current stack audit", icon: <Server size={18}/> },
                    { step: "2", title: "Migration", desc: "Data & App transfer", icon: <HardDrive size={18}/> },
                    { step: "3", title: "Optimization", desc: "Cost & Performance", icon: <RefreshCw size={18}/> },
                  ].map((item) => (
                ...
                <div className="bg-white rounded-3xl p-8 md:p-10 shadow-[0_20px_50px_rgba(0,0,0,0.3)]">
                  <form className="space-y-5">
                    <div className="grid grid-cols-2 gap-5">
                      ...
                      <div className="space-y-1"><label className="text-[10px] font-bold text-slate-400 uppercase">Current Provider</label>
                        <select className="w-full bg-slate-50 border border-slate-200 p-4 rounded-xl outline-none text-slate-900">
                          <option>None / On-Premise</option>
                          <option>AWS</option>
                          <option>Azure</option>
                    ...
                    <textarea rows={3} className="w-full bg-slate-50 border border-slate-200 p-4 rounded-xl outline-none focus:border-blue-600 transition-all text-slate-900" placeholder="Describe your migration needs..."></textarea>
                    <motion.button whileHover={{ scale: 1.01 }} whileTap={{ scale: 0.99 }} className="w-full bg-blue-600 text-white font-bold py-5 rounded-xl hover:bg-slate-900 transition-all shadow-xl shadow-blue-500/20">Send Inquiry</motion.button>
                  </form>
                </div>
              </div>
            </div>
