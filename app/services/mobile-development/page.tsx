        ...
        <div className="w-[90%] flex flex-col lg:flex-row gap-12">
            ...
            <div className="sticky top-28 space-y-8">
              ...
              <div className="bg-blue-600 rounded-xl p-8 text-white text-center relative overflow-hidden shadow-xl">
                <div className="relative z-10">
                  ...
                  <h4 className="text-2xl font-bold mb-2">Build an App?</h4>
                  <p className="text-blue-100 text-sm mb-6 font-light">From MVP to enterprise-scale mobility.</p>
          ...
          <div className="lg:w-2/3 order-1 lg:order-2 space-y-12">
            <div className="bg-white p-10 md:p-16 rounded-2xl border border-slate-100 shadow-sm">
              <h2 className="text-3xl md:text-5xl font-bold text-slate-900 mb-10 tracking-tight">Performance-Driven Mobile Experiences</h2>
              
              <p className="text-slate-600 text-lg leading-loose mb-12 font-light">
                In a mobile-first world, your application needs to be fast, intuitive, and reliable. We specialize in developing high-impact iOS and Android applications using Flutter and React Native, ensuring a single codebase delivers premium native performance with reduced time-to-market.
              </p>
             ...
             <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
              <div className="bg-white p-8 rounded-2xl border border-slate-100 shadow-sm">
                ...
                <h3 className="text-xl font-bold text-slate-900 mb-3">Native Performance</h3>
                <p className="text-slate-500 text-sm leading-relaxed font-light">
                  We optimize every line of code to ensure smooth animations and rapid 
                  load times, regardless of the user's hardware.
                </p>
              </div>
              <div className="bg-white p-8 rounded-2xl border border-slate-100 shadow-sm">
                <Layout className="text-blue-600 mb-4" size={32} />
                <h3 className="text-xl font-bold text-slate-900 mb-3">Adaptive UI/UX</h3>
                <p className="text-slate-500 text-sm leading-relaxed font-light">
                  Our designs adapt seamlessly to different screen sizes and orientations, 
          ...
          <div className="relative z-10">
            <div className="grid grid-cols-1 lg:grid-cols-12 gap-16">
              <div className="lg:col-span-4 space-y-10">
                <div>
                  <div className="flex items-center gap-3 mb-4">
                    ...
                    <span className="text-blue-500 font-bold uppercase tracking-widest text-xs">Mobile Strategy</span>
                  </div>
                  <h2 className="text-4xl font-bold text-white leading-tight mb-6 tracking-tight">Launch Your App <br /> on All Stores</h2>
                  <p className="text-slate-400 text-lg font-light leading-relaxed">From design to the App Store and Google Play, we manage the entire lifecycle of your mobile product.</p>
                </div>
                <div className="p-8 bg-white/5 border border-white/10 rounded-2xl backdrop-blur-sm shadow-2xl">
                  <p className="text-blue-500 uppercase tracking-widest text-[10px] font-black mb-2">Speak to a Developer:</p>
              ...
              <div className="lg:col-span-3 space-y-8 lg:border-l lg:border-white/10 lg:pl-12">
                <h4 className="text-white font-bold mb-8 uppercase tracking-wider text-xs opacity-70">App Roadmap</h4>
                <div className="space-y-12 relative">
                  <div className="absolute left-[19px] top-2 bottom-2 w-[1px] bg-white/10 -z-0" />
                  {[
                    { step: "1", title: "UX Design", desc: "User journey mapping", icon: <Layers size={18}/> },
                    { step: "2", title: "Development", desc: "Sprint-based coding", icon: <Cpu size={18}/> },
                    { step: "3", title: "Launch", desc: "Store submission & QA", icon: <Zap size={18}/> },
                  ].map((item) => (
              ...
              <div className="lg:col-span-5">
                <div className="bg-white rounded-3xl p-8 md:p-10 shadow-[0_20px_50px_rgba(0,0,0,0.3)]">
                  <form className="space-y-5">
                    ...
                    <textarea rows={3} className="w-full bg-slate-50 border border-slate-200 p-4 rounded-xl outline-none focus:border-blue-600 transition-all text-slate-900" placeholder="Tell us about your app idea..."></textarea>
                    <motion.button whileHover={{ scale: 1.01 }} whileTap={{ scale: 0.99 }} className="w-full bg-blue-600 text-white font-bold py-5 rounded-xl hover:bg-slate-900 transition-all shadow-xl shadow-blue-500/20">Get a Quote</motion.button>
                  </form>
                </div>
              </div>
            </div>
