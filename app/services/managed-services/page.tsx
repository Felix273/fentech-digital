...
export default function ManagedServicesPage() {
  const otherServices = [
    { name: "Managed Services", active: true, slug: "managed-services" },
  ...
  return (
    <main className="bg-[#F4F7FA] min-h-screen font-sans">
      <ServiceHero title="Managed Services" />
        ...
        <div className="w-[90%] flex flex-col lg:flex-row gap-12">
            ...
            <div className="sticky top-28 space-y-8">
              ...
              <div className="bg-blue-600 rounded-xl p-8 text-white text-center relative overflow-hidden shadow-xl">
                <div className="relative z-10">
                  ...
                  <h4 className="text-2xl font-bold mb-2">Need Any Help?</h4>
                  <p className="text-blue-100 text-sm mb-6 font-light">Available for Nairobi & Global tech hub.</p>
          ...
          <div className="lg:w-2/3 order-1 lg:order-2 space-y-12">
            <div className="bg-white p-10 md:p-16 rounded-2xl border border-slate-100 shadow-sm">
              <h2 className="text-3xl md:text-5xl font-bold text-slate-900 mb-10 tracking-tight">Proactive IT Management Built for Kenya</h2>
              
              {/* SQUEEZED WORD FIX: Relaxed leading and increased margin */}
              <p className="text-slate-600 text-lg leading-loose mb-12 font-light">
                At FenTech, we specialize in enterprise-grade IT infrastructure management tailored for the region. We handle the technical heavy lifting—from server maintenance to endpoint security—so you can focus on your core business growth without technical friction.
              </p>

              {/* SQUEEZED GRID FIX: Added gap-y-10 and py-10 */}
              <div className="grid grid-cols-1 md:grid-cols-2 gap-y-10 py-10 border-t border-slate-50">
                {["Nairobi-based Support Team", "Advanced Security Compliance", "Scalable Cloud Infrastructure", "Local & Offsite Data Backups", "24/7 Threat Monitoring", "Strategic IT Roadmapping"].map((item, idx) => (
             ...
             <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
              <div className="bg-white p-8 rounded-2xl border border-slate-100 shadow-sm">
                ...
                <h3 className="text-xl font-bold text-slate-900 mb-3">Minimal Downtime</h3>
                <p className="text-slate-500 text-sm leading-relaxed font-light">
                  Our proactive monitoring detects and resolves hardware and software 
                  vulnerabilities before they impact your workflow.
                </p>
              </div>
              <div className="bg-white p-8 rounded-2xl border border-slate-100 shadow-sm">
                ...
                <p className="text-slate-500 text-sm leading-relaxed font-light">
                  We ensure your systems meet both local data protection regulations 
            ...
            <div className="grid grid-cols-1 lg:grid-cols-12 gap-16">
              <div className="lg:col-span-4 space-y-10">
                <div>
                  ...
                  <h2 className="text-4xl font-bold text-white leading-tight mb-6 tracking-tight">Partner with Us for <br /> Comprehensive IT</h2>
                  <p className="text-slate-400 text-lg font-light leading-relaxed">We’re happy to answer any questions you may have and help you determine which of our services best fit your needs.</p>
                </div>
              ...
              <div className="lg:col-span-5">
                <div className="bg-white rounded-3xl p-8 md:p-10 shadow-[0_20px_50px_rgba(0,0,0,0.3)]">
                  <form className="space-y-5">
                    ...
                    <div className="space-y-1"><label className="text-[10px] font-bold text-slate-400 uppercase">Company Email</label><input type="email" className="w-full bg-slate-50 border border-slate-200 p-4 rounded-xl outline-none focus:border-blue-600 transition-all text-slate-900" /></div>
                    <textarea rows={3} className="w-full bg-slate-50 border border-slate-200 p-4 rounded-xl outline-none focus:border-blue-600 transition-all text-slate-900" placeholder="Message"></textarea>
                    <motion.button whileHover={{ scale: 1.01 }} whileTap={{ scale: 0.99 }} className="w-full bg-blue-600 text-white font-bold py-5 rounded-xl hover:bg-slate-900 transition-all shadow-xl shadow-blue-500/20">Submit Request</motion.button>
                  </form>
                </div>
              </div>
            </div>
