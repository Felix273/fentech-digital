...
export default function WebDevelopmentPage() {
  const otherServices = [
    ...
    { name: "Web Development", active: true, slug: "web-development" },
  ...
  return (
    <main className="bg-[#F4F7FA] min-h-screen font-sans">
      <ServiceHero title="Web Development" />
        ...
        <div className="w-[90%] flex flex-col lg:flex-row gap-12">
            ...
            <div className="sticky top-28 space-y-8">
              ...
              <div className="bg-blue-600 rounded-xl p-8 text-white text-center relative overflow-hidden shadow-xl">
                <div className="relative z-10">
                  ...
                  <h4 className="text-2xl font-bold mb-2">Have a Project?</h4>
                  <p className="text-blue-100 text-sm mb-6 font-light">Let's turn your idea into a digital reality.</p>
          ...
          <div className="lg:w-2/3 order-1 lg:order-2 space-y-12">
            <div className="bg-white p-10 md:p-16 rounded-2xl border border-slate-100 shadow-sm">
              <h2 className="text-3xl md:text-5xl font-bold text-slate-900 mb-10 tracking-tight">Enterprise Web Solutions Built for Scale</h2>
              
              <p className="text-slate-600 text-lg leading-loose mb-12 font-light">
                We don't just build websites; we engineer high-performance web applications. From custom e-commerce platforms to complex SaaS architectures, our development team utilizes modern stacks to deliver speed, security, and a seamless user experience across all devices.
              </p>
             ...
             <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
              <div className="bg-white p-8 rounded-2xl border border-slate-100 shadow-sm">
                ...
                <p className="text-slate-500 text-sm leading-relaxed font-light">
                  Our websites are built with "Technical SEO" at the core, ensuring maximum 
                  visibility and fast indexation on search engines.
                </p>
              </div>
              <div className="bg-white p-8 rounded-2xl border border-slate-100 shadow-sm">
                <Cpu className="text-blue-600 mb-4" size={32} />
                <h3 className="text-xl font-bold text-slate-900 mb-3">Modern Tech Stack</h3>
                <p className="text-slate-500 text-sm leading-relaxed font-light">
                  We use the latest technologies like Tailwind CSS, TypeScript, and 
                  Node.js to ensure your application is future-proof.
                </p>
              </div>
            </div>
          </div>
          ...
          <div className="relative z-10">
            <div className="grid grid-cols-1 lg:grid-cols-12 gap-16">
              <div className="lg:col-span-4 space-y-10">
                <div>
                  <div className="flex items-center gap-3 mb-4">
                    ...
                    <span className="text-blue-500 font-bold uppercase tracking-widest text-xs">Build your vision</span>
                  </div>
                  <h2 className="text-4xl font-bold text-white leading-tight mb-6 tracking-tight">Ready to Start <br /> Your Next Build?</h2>
                  <p className="text-slate-400 text-lg font-light leading-relaxed">Tell us about your technical requirements and business goals to receive a custom proposal.</p>
                </div>
                <div className="p-8 bg-white/5 border border-white/10 rounded-2xl backdrop-blur-sm shadow-2xl">
                  <p className="text-blue-500 uppercase tracking-widest text-[10px] font-black mb-2">Project Inquiries:</p>
              ...
              <div className="lg:col-span-3 space-y-8 lg:border-l lg:border-white/10 lg:pl-12">
                <h4 className="text-white font-bold mb-8 uppercase tracking-wider text-xs opacity-70">Development Cycle</h4>
                <div className="space-y-12 relative">
                  <div className="absolute left-[19px] top-2 bottom-2 w-[1px] bg-white/10 -z-0" />
                  {[
                    { step: "1", title: "Prototyping", desc: "Interactive wireframes", icon: <Laptop size={18}/> },
                    { step: "2", title: "Engineering", desc: "Agile coding phase", icon: <Code2 size={18}/> },
                    { step: "3", title: "Deployment", desc: "QA & Global launch", icon: <Rocket size={18}/> },
                  ].map((item) => (
                ...
                <div className="bg-white rounded-3xl p-8 md:p-10 shadow-[0_20px_50px_rgba(0,0,0,0.3)]">
                  <form className="space-y-5">
                    <div className="grid grid-cols-2 gap-5">
                      <div className="space-y-1"><label className="text-[10px] font-bold text-slate-400 uppercase">Name</label><input type="text" className="w-full bg-slate-50 border border-slate-200 p-4 rounded-xl outline-none focus:border-blue-600 transition-all text-slate-900" /></div>
                      <div className="space-y-1"><label className="text-[10px] font-bold text-slate-400 uppercase">Budget Range</label>
                        <select className="w-full bg-slate-50 border border-slate-200 p-4 rounded-xl outline-none text-slate-900">
                    ...
                    <div className="space-y-1"><label className="text-[10px] font-bold text-slate-400 uppercase">Email</label><input type="email" className="w-full bg-slate-50 border border-slate-200 p-4 rounded-xl outline-none focus:border-blue-600 transition-all text-slate-900" /></div>
                    <textarea rows={3} className="w-full bg-slate-50 border border-slate-200 p-4 rounded-xl outline-none focus:border-blue-600 transition-all text-slate-900" placeholder="Describe your web requirements..."></textarea>
                    <motion.button whileHover={{ scale: 1.01 }} whileTap={{ scale: 0.99 }} className="w-full bg-blue-600 text-white font-bold py-5 rounded-xl hover:bg-slate-900 transition-all shadow-xl shadow-blue-500/20">Send Proposal</motion.button>
                  </form>
                </div>
              </div>
            </div>
