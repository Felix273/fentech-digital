...
export default function Footer() {
  return (
    // Wrapper to handle the spacing from the Contact section
    <div className="w-full bg-white pt-24 pb-12 flex justify-center">
      
      {/* Footer Island - Set to 80% width */}
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-12 gap-12 mb-16">
            ...
            <div className="lg:col-span-5 space-y-8">
              ...
              <p className="text-slate-400 text-xl font-light leading-relaxed max-w-sm">
                Engineering the next generation of digital infrastructure with precision and transparency.
              </p>
              <div className="flex gap-4">
                {[Facebook, Twitter, Linkedin, Instagram].map((Icon, i) => (
                  <a key={i} href="#" className="w-12 h-12 rounded-2xl bg-white/5 flex items-center justify-center text-slate-400 hover:bg-blue-600 hover:text-white transition-all duration-300 border border-white/5 hover:border-blue-500">
                    <Icon size={20} />
                  </a>
                ))}
              </div>
            ...
            <div className="lg:col-span-4 space-y-8">
              ...
              <div className="space-y-6">
                <div className="flex items-center gap-4 text-slate-300">
                  ...
                  <span className="text-lg font-medium tracking-tight">+1 (800) 356-8933</span>
                </div>
                <div className="flex items-center gap-4 text-slate-300">
                  <div className="w-10 h-10 rounded-full bg-white/5 flex items-center justify-center border border-white/10">
                    <Mail size={18} className="text-blue-500" />
                  </div>
                  <span className="text-lg font-medium tracking-tight">hello@fentech.digital</span>
                </div>
                <div className="flex items-center gap-4 text-slate-300">
                  <div className="w-10 h-10 rounded-full bg-white/5 flex items-center justify-center border border-white/10">
                    <MapPin size={18} className="text-blue-500" />
                  </div>
                  <span className="text-lg font-medium tracking-tight">London, UK EC1</span>
                </div>
              </div>
            </div>
          </div>

          {/* BOTTOM BAR: No Copyright, just Links */}
